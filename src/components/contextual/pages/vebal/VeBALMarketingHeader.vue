...
<template>
  <div style="background-image: url('/images/backgrounds/vebal-bg.png');" class="w-full h-fit py-20 bg-cover rounded-xl gap-4 bg-no-repeat flex flex-col items-center justify-center text-white xl:mr-5">
